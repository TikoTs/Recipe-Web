...
# user_cocktail_name = input("Write cocktail's name: ").capitalize()
# user_ingr_list = user_ingr/.split(',')
# numb = 0
# length = 0
# item_name_str = 'smth'
# l_ingr = []
...
# position = 0
# one = 'ml'
# all_cocktails = Recipes.query.all()
# for ingredient in all_cocktails:
#     ingredients_list = ingredient.ingredients.strip('][').split(',')
#     for i in ingredients_list[position:ingredient.ingredients_numb - 1]:
#         for each in user_ingr_list:
#             if each in i:
#                 numb += 1
#     if numb / ingredient.ingredients_numb <= 1.5:
